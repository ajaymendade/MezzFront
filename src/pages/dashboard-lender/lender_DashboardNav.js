...
const LenderDashboardNav = () => {
  ...
  const navigationItems = [
    { label: 'Profile', icon: <AccountCircleIcon />, link: '/lender-dashboard/lender-profile' },
    { label: 'Dashboard', icon: <HomeIcon />, link: '/lender-dashboard' },
    { label: 'View Buyers', icon: <GroupIcon />, link: '/lender-dashboard/view-buyers' },
    { label: 'Payment Status', icon: <SettingsIcon />, link: '/lender-dashboard/Payment-status' },
    { label: 'Settings', icon: <SettingsIcon />, link: '/lender-dashboard/settings' },
    { label: 'Help & Support', icon: <HelpIcon />, link: '/lender-dashboard/support' },
    { label: 'Invoice Funding', icon: <GroupIcon />, link: '/lender-dashboard/lender-invoice-funding' },
  ];
...
export default LenderDashboardNav;
