...
const SellerDashboardNav = ({  }) => {
  ...
  const navigationItems = [
    ...
    { label: 'Dashboard', icon: <HomeIcon />, link: '/biz-dashboard' },
    { label: 'Invoice Generated', icon: <FastForwardIcon />, link: '/biz-invoice-generated' },
    { label: 'Invoice Recieved', icon: <TokenIcon />, link: '/biz-invoice-recieved' },
    { label: 'Tokens', icon: <DescriptionOutlinedIcon />, link: '/biz-tokens' },
    { label: 'Invoice', icon: <ReceiptIcon />, link: '/biz-invoice' },
    { label: 'Escrow account', icon: <ReceiptIcon />, link: '/biz-escrow-account' },
    { label: 'Admin', icon: <SettingsIcon />, link: '/biz-admin' },
  ];
